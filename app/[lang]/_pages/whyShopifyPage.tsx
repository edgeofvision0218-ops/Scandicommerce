...
interface WhyShopifyPageData {
  ...
  whatIsShopify?: { title?: string; paragraph1?: string; paragraph2?: string }
  shopifyFacts?: { title?: string; facts?: Array<{ statistic?: string; description?: string; source?: string }> }
  whyBusinessesChoose?: { title?: string; reasons?: Array<{ title?: string; description?: string; bulletPoints?: string[]; concludingParagraph?: string }> }
  whyScandicommerceSpecializes?: { title?: string; description?: string; specializations?: Array<{ title?: string; description?: string }> }
  shopifyAi?: { title?: string; description?: string; aiSolutions?: Array<{ title?: string; description?: string }> }
...
export default async function WhyShopifyPage({ params }: { params: Promise<{ lang: string; slug?: string }> }) {
  ...
  const pageData = await client.fetch<WhyShopifyPageData | null>(whyShopifyPageQuery, getQueryParams({}, language), { next: { revalidate: 0 } }).catch(() => null)
