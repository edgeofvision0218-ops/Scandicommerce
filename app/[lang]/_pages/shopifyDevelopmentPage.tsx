...
interface ShopifyDevPageData {
  ...
  whyShopify?: { whyShopifyTitle?: string; whyShopifySubtitle?: string; whyShopifyFeatures?: Array<{ title: string; description: string; icon?: string }> }
  scenarios?: { scenariosTitle?: string; scenariosItems?: Array<{ title: string; description: string; link?: string }> }
  howWeWork?: { howWeWorkTitle?: string; howWeWorkSteps?: Array<{ number: number; title: string; description: string }> }
  testimonial?: { testimonialRating?: number; testimonialQuote?: string; testimonialAuthorName?: string; testimonialAuthorTitle?: string; testimonialButtonText?: string; testimonialButtonLink?: string }
...
export default async function ShopifyDevelopmentPage({ params }: { params: Promise<{ lang: string; slug?: string }> }) {
  ...
  const pageData = await client.fetch<ShopifyDevPageData | null>(shopifyDevelopmentPageQuery, getQueryParams({}, language), { next: { revalidate: 0 } }).catch(() => null)
